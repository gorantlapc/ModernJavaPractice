...
public class StreamFlatMapEx {
    static void main() {
        ...
        List<String> products = orders.stream().flatMap(order -> order.product().stream())
                .toList(); // returns unmodifiable list of products

        // traditional way to do the same
        List<String> productsTraditional = new java.util.ArrayList<>();
        ...
        //
        List<String> products2 = new java.util.ArrayList<>();
